...
$GLOBALS['TL_DCA']['tl_module']['palettes'][PersonsModule::TYPE] = '{type_legend},name,headline,type;{person_legend},selectPersonsBy;{template_legend:collapsed},customTpl;{protected_legend:collapsed},protected;{expert_legend:collapsed},guests,cssID';
$GLOBALS['TL_DCA']['tl_module']['palettes']['__selector__'][] = 'selectPersonsBy';
$GLOBALS['TL_DCA']['tl_module']['subpalettes']['selectPersonsBy_personsByTag'] = 'personTags,personTagsCombination,personSortBy,personTpl,imgSize';
...
$GLOBALS['TL_DCA']['tl_module']['fields'] = array_merge(
    ...
    ['personSortBy' => [
        ...
        'reference' => &$GLOBALS['TL_LANG']['tl_module']['reference']['personSortBy'],
